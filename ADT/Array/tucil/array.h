...
typedef struct { 
	...
	int Neff;
  int MaxEl;  /* >=0, banyaknya elemen efektif */
} TabInt;
...
void AddAsLastEl (TabInt * T, ElType X); //UBAH BOY
/* Proses: Menambahkan X sebagai elemen terakhir tabel */
/* I.S. Tabel T boleh kosong, tetapi tidak penuh */
/* F.S. X adalah elemen terakhir T yang baru */
void AddEli (TabInt * T, ElType X, IdxType i); //UBAH BOY
...
void AddElUnik (TabInt * T, ElType X); //UBAH BOY
...
void Add1Urut (TabInt * T, ElType X); //UBAH BOY
